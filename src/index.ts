...
app.post('/api/website/templates', authMiddleware, requireAdmin, createWebsiteTemplate);
app.delete('/api/website/templates/:templateId', authMiddleware, requireAdmin, removeWebsiteTemplate);
